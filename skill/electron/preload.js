...
contextBridge.exposeInMainWorld('zhigui', {
  ...
  undoErrand: (data) => ipcRenderer.invoke('undo-errand', data),
  ...
  previewDelete: (data) => ipcRenderer.invoke('preview-delete', data),
  updateDecision: (data) => ipcRenderer.invoke('decision-update', data),
  deleteDecision: (data) => ipcRenderer.invoke('decision-delete', data),
